/*
 * cafe-gsettings.c: helper API for GSettings
 *
 ...
 */
gboolean
cafe_gsettings_schema_exists (const gchar* schema)
{
 ...
 */
gboolean
cafe_gsettings_is_valid_keyname (const gchar  *key,
                                 GError      **error)
{
  gint i;
...
gboolean
cafe_gsettings_append_strv (GSettings   *settings,
                            const gchar *key,
                            const gchar *value)
{
    gchar    **old;
...
gboolean
cafe_gsettings_remove_all_from_strv (GSettings   *settings,
                                     const gchar *key,
                                     const gchar *value)
{
    GArray    *array;
...
GSList*
cafe_gsettings_strv_to_gslist (const gchar *const *array)
{
    GSList *list = NULL;
    gint i;
    if (array != NULL) {
